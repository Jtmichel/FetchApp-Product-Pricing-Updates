...
<table>
    ...
    <?php
        function processFetchApp(){
            ...
            $fetch->setAuthenticationKey($_GET['fetchapp_key']);
            $fetch->setAuthenticationToken($_GET['fetchapp_token']);
           ...
           foreach ($products as $product) {
                ...
                if($product->getPrice() == $_GET['old_price']){
                    try{
                        // $set_product = new FetchApp->getProduct($product->getSKU());
                        $product->setPrice($_GET['new_price']);
